            ...
            <ContentTemplate>
                ...
                <section class="my-5">
                    ...
                    <div class="contenedor">
                        ...
                        <div class="input-contenedor">
                            <i class="fas fa-key icon"></i>
                            <asp:TextBox ID="txt_user" type="password" placeholder="Usuario" runat="server"></asp:TextBox>
                        </div>



                        <div class="control">
                            <asp:Button ID="btn_registrar" class="button" runat="server" Text="Registrar" OnClick="btn_registrar_Click1" />
