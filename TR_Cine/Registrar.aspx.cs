...

    {
        ...
        protected void btn_registrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_nombre.Text==String.Empty || txt_pass.Text==String.Empty || txt_mail.Text==String.Empty || 
                    txt_user.Text==String.Empty || txt_apellido.Text==String.Empty || txt_cedula.Text==String.Empty ||
                    txtdireccion.Text==String.Empty || txt_cel.Text==String.Empty)
                {
                    lbl_mensaje.ForeColor = Color.Red;
                    lbl_mensaje.Text = "Campos vacios";
                }
                else
                {
